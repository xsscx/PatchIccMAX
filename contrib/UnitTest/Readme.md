...
- [cve-2023-46602.icc](https://github.com/xsscx/PatchIccMAX/tree/development/contrib/UnitTest/cve-2023-46602.icc), [cve-2023-46602.zsh](https://github.com/xsscx/PatchIccMAX/tree/development/contrib/UnitTest/cve-2023-46602.zsh), [cve-2023-46602-icFixXml-function-IccTagXml_cpp-line_337-baseline-variant-000.xml](https://github.com/xsscx/PatchIccMAX/tree/development/contrib/UnitTest/cve-2023-46602-icFixXml-function-IccTagXml_cpp-line_337-baseline-variant-000.xml)  
...
- [TestCIccTagXmlProfileSequenceId.cpp](https://github.com/xsscx/PatchIccMAX/tree/development/contrib/UnitTest/TestCIccTagXmlProfileSequenceId.cpp)  
  A unit test targeting specific vulnerabilities, particularly around handling of the ICC profile sequence ID tag in XML.

- [TestParseText.cpp](https://github.com/xsscx/PatchIccMAX/tree/development/contrib/UnitTest/TestParseText.cpp)  
...
- [iccApplyNamedCmm_allocator_mismatch_check.sh](https://github.com/xsscx/PatchIccMAX/tree/development/contrib/UnitTest/iccApplyNamedCmm_allocator_mismatch_check.sh)  
  Runs a series of tests with Asan enabled to catch allocator mismatch errors within the `iccApplyNamedCmm` tool.

- [pcs_asan_test_CreateAllProfiles.sh](https://github.com/xsscx/PatchIccMAX/tree/development/contrib/UnitTest/pcs_asan_test_CreateAllProfiles.sh)  
...
- [pcs_refactor_create_profiles.sh](https://github.com/xsscx/PatchIccMAX/tree/development/contrib/UnitTest/pcs_refactor_create_profiles.sh), [pcs_refactor_build_createprofiles_check.sh](https://github.com/xsscx/PatchIccMAX/tree/development/contrib/UnitTest/pcs_refactor_build_createprofiles_check.sh)  
...
### minimized
```
/bin/sh -c "$(curl -fsSL https://raw.githubusercontent.com/xsscx/PatchIccMAX/refs/heads/development/contrib/UnitTest/build_development_branch.sh)"
```

### build.log

```
/bin/sh -c "$(curl -fsSL https://raw.githubusercontent.com/xsscx/PatchIccMAX/refs/heads/development/contrib/UnitTest/build_development_branch.sh)" > build.log 2>&1 & script_pid=$!; while [ ! -f build.log ]; do sleep 1; done; tail --pid=$script_pid -f build.log; wait $script_pid
```
