...
***Remote***
```
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/xsscx/PatchIccMAX/refs/heads/development/contrib/UnitTest/TestParseText.sh)"
```
...
The source code and this script are released under the **GNU General Public License (GPL)** version 3.0 or later.
