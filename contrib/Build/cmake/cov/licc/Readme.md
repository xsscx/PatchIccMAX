# iccScan | ICC Profile Scanner

`iccScan` is a mashup of [LittleCMS 2.x](https://www.littlecms.com/) and [ICC.1:2024-05 (iccMAX 2.3.1)](https://www.color.org/specification/ICC_Max.xalter), designed to demonstrate a measurement and analysis toolchain for ICC profiles.
...
iccScan Profile Scanner [LittleCMS 2.16, IccProfLib 2.3.1, IccLibXML 2.3.1]
