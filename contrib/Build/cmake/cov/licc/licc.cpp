...
// ---------------------------
// Project headers (iccdev stack, utilities)
// ---------------------------
#include "IccDefs.h"
...
// ----------------------------------------------------------------------------------
// Show a message on the profile (non-fatal diagnostic)
// ----------------------------------------------------------------------------------
...
// -------------------------------
// Rendering Intent + Profile Class/Subclass
// -------------------------------
  if (!pHdr) {
    PrintTimestamp(stderr);
...
// -------------------------------
// Spectral PCS / Ranges / MCS Color Space
// -------------------------------
  if (!pHdr) {
    PrintTimestamp(stderr);
...
// -------------------------------
// iccMAX Profile Tags + LittleCMS Outputs
// -------------------------------
  PrintTimestamp(stderr);
  std::fprintf(stderr, "\niccMAX Profile Tags\n");
  std::fprintf(stderr, "------------\n");
...
// -------------------------------
// Profile Tags Enumeration + Metadata/Colorant
// -------------------------------
  PrintTimestamp(stderr);
  std::fprintf(stderr, "\nProfile Tags\n");
  std::fprintf(stderr, "------------\n");
...
// -----------------------------------------------------------------------------
// IsRoundTripable() - call into iccdev
// -----------------------------------------------------------------------------
...
int main(int argc, char* argv[])
{
  ...
  std::fprintf(stderr,
               "\n"
               "ICC Profile Scanner v0.2 [LittleCMS %.2f, IccProfLib %s, IccLibXML %s]\n"
