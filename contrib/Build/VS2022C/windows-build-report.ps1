...
# Copyright (c) Copyright (c) David H Hoyt LLC. All rights reserved.
# Author: David Hoyt
# Date: 25-FEB-2025 1712 EST
...
# iex (iwr -Uri " https://raw.githubusercontent.com/xsscx/PatchIccMAX/refs/heads/pr114/contrib/Build/VS2022C/windows-build-report.ps1").Content
#
# ============================================================

# Start of Script
Write-Host "============================= Starting Windows Build Report =============================" -ForegroundColor Green
Write-Host "Copyright (c) David H Hoyt LLC. All rights reserved." -ForegroundColor Green
Write-Host "Last Updated: 25-FEB-2025 1712 EST by David Hoyt" -ForegroundColor Green
