...
#
# Last Updated: 16-FEB-2025 at 0821 EST by David Hoyt | h02332
#
# Intent:
...
#
# Features:
#   - zsh xxd dump of Testing/ .icc color profiles
#
# Usage:
...
# Banner
echo "Copyright (c) 2025 David H Hoyt LLC | All rights reserved."
echo "zsh xxd check of Testing/ .icc color profiles"
echo "Last Updated: 0821 EST on 16-FEB-2025"
